...
namespace NetSdrClientAppTests
{
    public class NetSdrMessageHelperTests
    {
        ...
        public void GetControlItemMessage_WithEmptyParameters_ShouldWork()
        {
            ...
            // Assert
            Assert.That(message.Length, Is.EqualTo(4)); // 2 header + 2 item code
        }
        ...
        public void GetDataItemMessage_WithEmptyParameters_ShouldWork()
        {
            ...
            // Assert
            Assert.That(message.Length, Is.EqualTo(2)); // Only header
        }
        ...
        public void GetDataItemMessage_WithMaxLength_ShouldHandleEdgeCase()
        {
            ...
            // Assert
            Assert.That(message.Length, Is.EqualTo(8194)); // 8192 + 2 header
        }
        ...
        public void GetSamples_WithPartialSample_ShouldIgnoreIncompleteData()
        {
            ...
            // Assert
            Assert.That(samples.Count, Is.EqualTo(1)); // Only one complete sample
        }
        ...
        public void GetControlItemMessage_AllMsgTypes_ShouldWork()
        {
            ...
            foreach (var type in types)
            {
                ...
                Assert.That(message.Length, Is.GreaterThan(0), $"Failed for type: {type}");
            }
        }
